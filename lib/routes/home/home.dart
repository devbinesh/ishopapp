                  ...
                  Expanded(
                    ...
                    child: InkWell(
                      onTap: () => BlocProvider.of<LocationBloc>(context)
                        ..add(LocationInitial())
                        ..add(LocationChanged(context)), //changeLocation(),
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          BlocBuilder<LocationBloc, LocationState>(
                            ...
                            if (location is LocationFetched) {
                              return locationExpanded(location.currentLocation);
                            } else if (location is LocationChanged) {
                              return locationExpanded(location.currentLocation);
                            } else if (location is LocationChangedState) {
                              return locationExpanded(location.currentLocation);
                            } else if (location is LocationPref) {
                              return locationExpanded(location.currentLocation);
                            } else {
                              return locationExpanded(location.currentLocation);
                            }
